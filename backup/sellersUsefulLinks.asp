...
<%
Dim rsUseful__MMColParam
rsUseful__MMColParam = "true"
If (Request("MM_EmptyValue") <> "") Then 
  rsUseful__MMColParam = Request("MM_EmptyValue")
End If
%>
<%
Dim rsUseful
Dim rsUseful_numRows

Set rsUseful = Server.CreateObject("ADODB.Recordset")
rsUseful.ActiveConnection = MM_clsConnection_STRING
rsUseful.Source = "SELECT ul_desc, ul_title, ul_url  FROM tb_useful_link  WHERE ul_status = " + Replace(rsUseful__MMColParam, "'", "''") + " and ul_type = true  ORDER BY ul_title ASC"
rsUseful.CursorType = 0
rsUseful.CursorLocation = 2
rsUseful.LockType = 1
rsUseful.Open()
...
Repeat1__numRows = -1
Repeat1__index = 0
rsUseful_numRows = rsUseful_numRows + Repeat1__numRows
%>
...
<table width="750" border="0" align="center" cellpadding="0" cellspacing="0"> 
  ...
  <tr> 
    ...
    <td valign="top"><table width="720" border="0" cellspacing="0" cellpadding="0"> 
        <tr> 
          <td colspan="5" valign="top" bgcolor="#E3C66E"><!--#include file="includes/menuTop_sellers.asp" --></td> 
        ...
        <tr> 
          ...
          <td width="178" valign="top" bgcolor="#E3C66E"><!--#include file="includes/menu_sellers.asp" --></td>
            ...
            <div id="content"> 
              <table width="100%" border="0" cellspacing="0" cellpadding="0"> 
                <tr bgcolor="#FFFFFF"> 
                  ...
                  <td width="400"><img src="images/pg_ttl__usefulLinks.gif" width="400" height="68"> 
                    <!--PAGE TITLE -->
                  </td> 
                ...
                <tr bgcolor="#FFFFFF">
                  ...
                  <td colspan="2"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td> <% 
While ((Repeat1__numRows <> 0) AND (NOT rsUseful.EOF)) 
%>
                          <table width="100%" border="0" align="center" cellpadding="2" cellspacing="1">
                            <tr> 
                              <td class="cntHdr01"><%=(rsUseful.Fields.Item("ul_title").Value)%></td>
                            </tr>
                            <tr> 
                              <td><%=(rsUseful.Fields.Item("ul_desc").Value)%></td>
                            </tr>
                            <tr> 
                              <td><a href="<%=(rsUseful.Fields.Item("ul_url").Value)%>" target="_blank"><%=(rsUseful.Fields.Item("ul_url").Value)%></a></td>
                            </tr>
                            <tr>
                              <td>&nbsp;</td>
                            </tr>
