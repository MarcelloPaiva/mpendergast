...
rsUseful.Source = "SELECT ul_desc, ul_title, ul_url  FROM tb_useful_link  WHERE ul_status = " + Replace(rsUseful__MMColParam, "'", "''") + " and ul_type = false  ORDER BY ul_title ASC"
  ...
  <tr> 
    ...
    <td valign="top"><table width="720" border="0" cellspacing="0" cellpadding="0"> 
        ...
        <tr> 
          ...
          <td width="178" valign="top" bgcolor="#E3C66E"><table width="178" border="0" cellpadding="0" cellspacing="0" style="height: 100%;">
            <tr>
