              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr bgcolor="#FFFFFF"> 
                  ...
                  <td colspan="2"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr> 
                        <td colspan="2" class="cntHdr02"><%= FormatCurrency((rsDetails.Fields.Item("pro_price").Value), -1, -2, -2, -2) %></td>
                      </tr>
                      <tr>
                    ...
                    <table width="100%"  border="0" cellpadding="0" cellspacing="0">
                      ...
                      <tr> 
                        <td valign="top" class="cntTxt01">Additional photos are available in the <a href="propertyPhotos.asp?id=<%=(rsDetails.Fields.Item("pro_id").Value)%>">Photo Gallery</a>.<br>
                          Experience the <a href="propertyVtour.asp?id=<%=(rsDetails.Fields.Item("pro_id").Value)%>">virtual tour</a> of this property or <a href="contact.asp?id=<%=(rsDetails.Fields.Item("pro_id").Value)%>">schedule an appointment</a> to visit it in person.<br></td>
                        <td valign="top">&nbsp;</td>
                      </tr>
                      <tr> 
                        <td valign="top">&nbsp;</td>
