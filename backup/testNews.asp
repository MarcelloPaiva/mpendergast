...
<!--#include file="includes/commonFunc.asp" -->
<%
...
%>
                <tr bgcolor="#FFFFFF"> 
                  ...
                  <td colspan="2"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        <td><strong><%=(rsSample.Fields.Item("sa_title").Value)%></strong></td>
                        <td width="20">&nbsp;</td>
                      </tr>
                      <tr> 
                        <td><% if (rsSample.Fields.Item("sa_image").Value) <> "" then %>
                          <img src="imagesDB/<%=(rsSample.Fields.Item("sa_image").Value)%>" align="left">
<% end if %> <%=(rsSample.Fields.Item("sa_desc").Value)%></td>
                        <td>&nbsp;</td>
                      </tr>
<% if (rsSample.Fields.Item("sa_url").Value) <> "" then%>
                      <tr> 
                        <td><a href="<%=(rsSample.Fields.Item("sa_url").Value)%>"><%=(rsSample.Fields.Item("sa_url").Value)%></a></td>
                        <td>&nbsp;</td>
                      </tr>
<% end if %>
<% if (rsSample.Fields.Item("sa_doc").Value) <> "" then %>
                      <tr> 
                        <td>[<a href="imagesDB/<%=(rsSample.Fields.Item("sa_doc").Value)%>" target="_blank">Download Document</a>]</td>
                        <td>&nbsp;</td>
                      </tr>
<% end if %>
                      <tr>
