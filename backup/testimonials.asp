...
<%
Dim rsTestimonial__MMColParam
rsTestimonial__MMColParam = "true"
If (Request("MM_EmptyValue") <> "") Then 
  rsTestimonial__MMColParam = Request("MM_EmptyValue")
End If
%>
<%
Dim rsTestimonial
Dim rsTestimonial_numRows

Set rsTestimonial = Server.CreateObject("ADODB.Recordset")
rsTestimonial.ActiveConnection = MM_clsConnection_STRING
rsTestimonial.Source = "SELECT tes_desc, tes_image, tes_name FROM tb_testimonial WHERE tes_status = " + Replace(rsTestimonial__MMColParam, "'", "''") + " ORDER BY tes_id DESC"
rsTestimonial.CursorType = 0
rsTestimonial.CursorLocation = 2
rsTestimonial.LockType = 1
rsTestimonial.Open()

rsTestimonial_numRows = 0
%>
<%
...
Repeat1__numRows = -1
Repeat1__index = 0
rsTestimonial_numRows = rsTestimonial_numRows + Repeat1__numRows
%>
            ...
            <div id="content"> 
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr bgcolor="#FFFFFF"> 
                  ...
                  <td width="400"><img src="images/pg_ttl__testimonials.gif" width="400" height="68"> 
                    <!--PAGE TITLE -->
                  </td>
                ...
                <tr bgcolor="#FFFFFF"> 
                  <td>&nbsp;</td>
                  <td colspan="2"> <% 
While ((Repeat1__numRows <> 0) AND (NOT rsTestimonial.EOF)) 
%>
                    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        <td width="449" rowspan="2" align="center" valign="top" class="cntTxt01"><em><%=(rsTestimonial.Fields.Item("tes_desc").Value)%></em>
                        </em></p></td>
                        <td width="20" rowspan="3" valign="top"><img src="images/spacer.gif" width="20" height="20"></td>
                        <td width="77" rowspan="4" valign="top"> <% if (rsTestimonial.Fields.Item("tes_image").Value) <> "" then %> <img src="imagesDB/<%=(rsTestimonial.Fields.Item("tes_image").Value)%>" width="160" height="108"> 
                          <% end if %> </td>
                        <td width="20">&nbsp;</td>
                      </tr>
                      <tr> 
                      ...
                      <tr>
                        <td align="right" valign="top"><%=(rsTestimonial.Fields.Item("tes_name").Value)%></td>
                        <td>&nbsp;</td>
                      </tr>
                      <tr>
                        <td valign="top">&nbsp;</td>
                      ...
                      <tr>
                        ...
                        <td valign="top">&nbsp;</td>
                        <td valign="top"><img src="images/spacer.gif" width="160" height="20"></td>
                        <td>&nbsp;</td>
                      </tr>
                    </table>
                    <% 
