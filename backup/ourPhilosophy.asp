...
<%
Dim rsPhilosophy__MMColParam
rsPhilosophy__MMColParam = "5"
If (Request("MM_EmptyValue") <> "") Then 
  rsPhilosophy__MMColParam = Request("MM_EmptyValue")
End If
%>
<%
Dim rsPhilosophy
Dim rsPhilosophy_numRows

Set rsPhilosophy = Server.CreateObject("ADODB.Recordset")
rsPhilosophy.ActiveConnection = MM_clsConnection_STRING
rsPhilosophy.Source = "SELECT * FROM tb_sec_text WHERE sec_id = " + Replace(rsPhilosophy__MMColParam, "'", "''") + ""
rsPhilosophy.CursorType = 0
rsPhilosophy.CursorLocation = 2
rsPhilosophy.LockType = 1
rsPhilosophy.Open()

rsPhilosophy_numRows = 0
%>
<%
...
Repeat1__numRows = -1
Repeat1__index = 0
rsPhilosophy_numRows = rsPhilosophy_numRows + Repeat1__numRows
%>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0"> 
                ...
                <tr bgcolor="#FFFFFF">
                  ...
                  <td colspan="2"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                      <% 
						While ((Repeat1__numRows <> 0) AND (NOT rsPhilosophy.EOF)) 
						%>                    
					<tr>
                      <td>
                      <p><strong><%=(rsPhilosophy.Fields.Item("st_title").Value)%></strong><br><br>
                          <img src="images/prp_pht_PLACEHOLDER.gif" width="160" height="160" align="left" hspace="10"><%=(rsPhilosophy.Fields.Item("st_desc").Value)%><br>
                          </p>
                </td>
                      <td width="20">&nbsp;</td>
