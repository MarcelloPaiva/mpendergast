  ...
  <tr> 
    ...
    <td valign="top"><table width="720" border="0" cellspacing="0" cellpadding="0"> 
        ...
        <tr> 
          ...
          <td width="178" valign="top" bgcolor="#E3C66E"><!--#include file="includes/menu_buyers.asp" --></td>
            ...
            <div id="content"> 
              <table width="100%" border="0" cellspacing="0" cellpadding="0"> 
                <tr bgcolor="#FFFFFF"> 
                  ...
                  <td width="400"><img src="images/pg_ttl__searchCapeCodProperties.gif" width="400" height="68"> 
                    <!--PAGE TITLE --> </td> 
                  <td width="125"><img src="images/cnt_topLogo.gif" width="125" height="68"></td> 
                </tr> 
                 
                <tr bgcolor="#FFFFFF"> 
                  <td colspan="3" align="center"><iframe width="550" height="1000" frameborder="0" scrolling="auto" src="http://ccimls.rapmls.com/scripts/mgrqispi.dll?APPNAME=Capecod&PRGNAME=MLSLogin&ARGUMENT=QSrMmNX%2BKcS%2BvJopM%2FSgA5X9NgAkDVBys%2Bt8gsyZEZc%3D&KeyRid=1"></iframe></td> 
                </tr> 
                <tr bgcolor="#FFFFFF"> 
                  <td>&nbsp;</td> 
                  <td colspan="2">&nbsp;</td> 
...
<!-- 
ORIGINAL CODE FROM MLS

<table width=100% cellpadding=0 cellspacing=0 border=0 bgcolor=#CC0000>
<tr><Td align=center>
<font face=arial size=+2 color=#FFFFFF><b>Martha Pendergast</b></font>
</td>
<td align=center><font face=arial size=2 color=#FFFFFF><b>
Martha Pendergast Real Estate<br>
85 Chase Road<br>
Falmouth, MA 02540<Br>
(508)548-4040<br>
<a href=mailto:martha@marthapendergastrealestate.com><font color=#FFFFFF>martha@marthapendergastrealestate.com</font></a><br>
<a href=http://www.marthapendergastrealestate.com target=blank><font color=#FFFFFF>www.marthapendergastrealestate.com
</b></font></td>
</tr></table>							
