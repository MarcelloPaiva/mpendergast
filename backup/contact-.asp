                    ...
                    <tr>
                        <td> 
                          <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr> 
                              <td width="110" rowspan="2" align="left"><img src="imagesDB/<%=(rsImage.Fields.Item("pro_img1").Value)%>" width="110" height="78" hspace="10" border="1"></td>
                              <td valign="top"><strong><%=(rsImage.Fields.Item("pro_name").Value)%></strong></td>
                            </tr>
                            <tr>
...
<form name="form1" method="post" action="contactAction.asp">
  <input name="emailTO" type="hidden" value="sales@marthapendergastrealestate.com">
                            <input name="pro_id" type="hidden" id="pro_id" value="<%=(rsImage.Fields.Item("pro_id").Value)%>">
                            <input name="pro_name" type="hidden" id="pro_name" value="<%=(rsImage.Fields.Item("pro_name").Value)%>">
