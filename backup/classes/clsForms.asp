<%
	class clsForms
		...
		public function frmPropertyImage
			...
			If Err.Number <> 0 then 
				frmProperty = "Failured Uploading.<br>"
				Exit function
			end if
		...
		public function frmTestimonial
			...
			If Err.Number <> 0 then 
				frmTestimonial = "Failured Uploading.<br>"
				Exit function
			end if
		...
		public function frmSampleAd
			...
			If Err.Number <> 0 then 
				frmSampleAd = "Failured Uploading.<br>"
				Exit function
			end if
			...
			if intTitle = "" then erro = erro & "Please fill the Title.<br>"
			'if url = "" then erro = erro & "Fill the URL.<br>"
			if desc = "" then erro = erro & "Please fill the Description.<br>"
		...
		public function frmState
			...
			if abreviation = "" then erro = erro & "Fill the Abreviation.<br>"
		...
		public function frmSecText
			...
			If Err.Number <> 0 then 
				frmSecText = "Failured Uploading.<br>"
				Exit function
			end if
		...
		public function frmUserChangePassword
			...
			if pass1 = "" then erro = erro & "Fill actual password field.<br>"
