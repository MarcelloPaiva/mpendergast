...
<%
	...
	sql = "select stt_id, stt_name, stt_abrev from tb_state order by stt_abrev, stt_name"
...
%>
      <table width="550" border="0" align="center" cellpadding="2" cellspacing="3">
        <tr> 
          <td width="409" class="admHdr01">STATES</td>
          <td width="141" align="right"><a href="mngState.asp"><img src="images/new.gif" width="13" height="15" border="0" align="absmiddle"> 
            Add new </a></td>
        </tr>
      </table> 
      <table width="450" border="0" align="center" cellpadding="2" cellspacing="3">
        <tr> 
          <td height="4" colspan="3" bgcolor="#CCCCCC"><img src="../images/spacer.gif"></td>
        </tr>
...
%>
        <tr class="txt2"> 
          <td width="355">&raquo; <%= rs("stt_abrev") %> - <%= rs("stt_name") %></td>
          <td width="39" align="center"><a href="mngState.asp?id=<%= rs("stt_id") %>"><img src="images/edit.gif" alt="View / Edit" width="13" height="15" border="0"></a></td>
          <td width="32" align="center"><a href="mngState.asp?action=delete&id=<%= rs("stt_id") %>"><img src="images/remove.gif" alt="Remove" width="13" height="15" border="0"></a></td>
        </tr>
        <tr> 
