...
<%
	...
	sql = "select sa_id, sa_title, sa_status from tb_sample_ad order by sa_title"
...
%>
      <table width="550" border="0" align="center" cellpadding="2" cellspacing="3">
        <tr> 
          <td width="409" class="admHdr01">SAMPLE AD</td>
          <td width="141" align="right"><a href="mngSampleAd.asp"><img src="images/new.gif" width="13" height="15" border="0" align="absmiddle"> 
            Add new </a></td>
        </tr>
      </table> 
...
%>
        <tr class="txt2"> 
          <td width="338">&raquo; <%= rs("sa_title") %></td>
          <td width="27" align="center"><a href="mngSampleAd.asp?id=<%= rs("sa_id") %>"><img src="images/edit.gif" alt="View / Edit" width="13" height="15" border="0"></a></td>
          <td width="22" align="center"><a href="mngSampleAd.asp?action=delete&id=<%= rs("sa_id") %>"><img src="images/remove.gif" alt="Remove" width="13" height="15" border="0"></a></td>
          <td width="32" align="center"><%= getOnOffButton( rs("sa_id"), rs("sa_status") , "sample_ad") %></td>
        </tr>
        <tr> 
