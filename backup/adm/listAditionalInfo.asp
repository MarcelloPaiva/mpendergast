...
<%
	...
	sql = "select ai_id, ai_title, ai_status from tb_aditional_information order by ai_title"
...
%>
      <table width="550" border="0" align="center" cellpadding="2" cellspacing="3">
        <tr> 
          <td width="409" class="admHdr01">ADDITIONAL INFORMATION</td>
          <td width="141" align="right"><a href="mngAditionalInfo.asp"><img src="images/new.gif" width="13" height="15" border="0" align="absmiddle"> 
            Add new </a></td>
        </tr>
      </table> 
...
%>
        <tr class="txt2"> 
          <td width="338">&raquo; <%= rs("ai_title") %></td>
          <td width="27" align="center"><a href="mngAditionalInfo.asp?id=<%= rs("ai_id") %>"><img src="images/edit.gif" alt="View / Edit" width="13" height="15" border="0"></a></td>
          <td width="22" align="center"><a href="mngAditionalInfo.asp?action=delete&id=<%= rs("ai_id") %>"><img src="images/remove.gif" alt="Remove" width="13" height="15" border="0"></a></td>
          <td width="32" align="center"><%= getOnOffButton( rs("ai_id"), rs("ai_status") , "aditional_information") %></td>
        </tr>
        <tr> 
