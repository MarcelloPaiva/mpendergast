...
%>
      <table width="550" border="0" align="center" cellpadding="2" cellspacing="3">
        <tr> 
          <td width="409" class="admHdr01">FEATURE TypeS</td>
          <td width="141" align="right"><a href="mngFeature.asp"><img src="images/new.gif" width="13" height="15" border="0" align="absmiddle"> 
            Add new </a></td>
        </tr>
      </table> 
...
%>
        <tr class="txt2"> 
          <td width="355">&raquo; <%= rs("pf_name") %></td>
          <td width="39" align="center"><a href="mngFeature.asp?id=<%= rs("pf_id") %>"><img src="images/edit.gif" alt="View / Edit" width="13" height="15" border="0"></a></td>
          <td width="32" align="center"><a href="mngFeature.asp?action=delete&id=<%= rs("pf_id") %>"><img src="images/remove.gif" alt="Remove" width="13" height="15" border="0"></a></td>
        </tr>
        <tr> 
