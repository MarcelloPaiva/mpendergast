...
<%
	...
	sql = "select usr_id, usr_name, usr_status from tb_user order by usr_name"
...
%>
      <table width="550" border="0" align="center" cellpadding="2" cellspacing="3">
        <tr> 
          <td width="409" class="admHdr01">USERS</td>
          <td width="141" align="right"><a href="mngUser.asp"><img src="images/new.gif" width="13" height="15" border="0" align="absmiddle"> 
            Add new </a></td>
        </tr>
      </table> 
      <table width="450" border="0" align="center" cellpadding="2" cellspacing="3">
        ...
        <tr align="center"> 
          <td height="70" colspan="5" class="txt1">Not found !!!</td>
        </tr>
        <%
	else
...
%>
        <tr class="txt2"> 
          <td>&raquo; <%= rs("usr_name") %></td>
          <td width="57" align="center"><a href="mngUserAccess.asp?usr_id=<%= rs("usr_id") %>">access</a></td>
          <td width="25" align="center"><a href="mngUser.asp?id=<%= rs("usr_id") %>"><img src="images/edit.gif" alt="View / Edit" width="13" height="15" border="0"></a></td>
          <td width="20" align="center"><a href="mngUser.asp?action=delete&id=<%= rs("usr_id") %>"><img src="images/remove.gif" alt="Remove" width="13" height="15" border="0"></a></td>
          <td width="37" align="center"><%= getOnOffButton( rs("usr_id"), rs("usr_status") , "user") %></td>
        </tr>
        <tr> 
