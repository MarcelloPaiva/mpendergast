...
<%
	...
	sql = "select cli_id, cli_name from tb_client order by cli_name"
...
%>
      <table width="550" border="0" align="center" cellpadding="2" cellspacing="3">
        <tr> 
          <td width="409" class="admHdr01">CLIENTS </td>
          <td width="141" align="right"><a href="mngClient.asp"><img src="images/new.gif" width="13" height="15" border="0" align="absmiddle"> 
            Add new </a></td>
        </tr>
      </table> 
...
%>
        <tr class="txt2"> 
          <td width="276">&raquo; <%= rs("cli_name") %></td>
          <td width="72" align="center"><a href="mngProperty.asp?cli_id=<%= rs("cli_id") %>">new 
            property</a></td>
          <td width="38" align="center"><a href="mngClient.asp?id=<%= rs("cli_id") %>"><img src="images/edit.gif" alt="View / Edit" width="13" height="15" border="0"></a></td>
          <td width="33" align="center"><a href="mngClient.asp?action=delete&id=<%= rs("cli_id") %>"><img src="images/remove.gif" alt="Remove" width="13" height="15" border="0"></a></td>
        </tr>
        <tr> 
